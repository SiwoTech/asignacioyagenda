...
if(!empty($id) && !empty($titulo) && !empty($color) && !empty($inicio) && !empty($fin)){
    ...
    $consulta_eventos = "UPDATE cancun SET titulo='$titulo', operador='$operador', servicio='$servicio', color='$color', inicio='$inicio_barra', fin='$fin_barra', observa='$observa' WHERE id='$id'";
