...
if(!empty($titulo) && !empty($color) && !empty($inicio) && !empty($fin)){
    ...
    $consulta_eventos = "INSERT INTO playa (titulo, operador, servicio, color, inicio, fin, observa) VALUES ('$titulo', '$operador', '$servicio', '$color', '$inicio_barra', '$fin_barra', '$observa')";
